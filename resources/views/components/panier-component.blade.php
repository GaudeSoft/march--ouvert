...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<main id="main" class="main-site">
        ...
        <div class="summary">
            ...
            <div class="checkout-info">
               <!-- <label class="checkbox-field">
                ...
                <a class="btn btn-checkout" href="{{ route('paiement.index') }}"><b>Passez la commande</b></a>
        ...
        @else
            <p  style="font-weight: bold;font-size:xx-large; color:#139630;margin-top:15%;text-align:center">
            <a class="link-to-shop" href="/boutique" style="text-decoration:none; color:#139630"> Votre panier est vide ajouter un produit ici </a>
            </p>
        @endif
