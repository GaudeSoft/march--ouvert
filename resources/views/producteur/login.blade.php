...
<body>
    ...
    <div class="container mt-5" style="width: auto;">
        ...
        @endif
        <form action="/connexion-producteur" method="post">
            @csrf
         
            <div class="row">
                <div class="col-md-6">
                    <label for="" class="col-md-4 col-form-label " style="color:black;">Entrez votre email</label>
                    <input type="email" name="email" id="email" class="form-control " require>

                   
                </div>
                <div class="col-md-6">
                    <label for="" class="col-md-4 col-form-label " style="color:black;">Entrez votre mot de passe</label>
